...
class TestTable(unittest.TestCase):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.table_test_cases = get_test_cases('tables')
        self.grammar_test_cases = get_test_cases('grammars')

    def test_normal_form(self):
        '''Show that the SLR table equivalency algorithm works correctly for
        several test cases.'''
        for test in self.table_test_cases:
    ...
    def test_build_slr_table(self):
        ...
        for test in self.grammar_test_cases:
